        ...
        <div className="insta">
            ...
            {/* <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/reel/C5vqFDOOTRA/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="14" styles=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
                <div styles="padding:16px;">
                    <a href="https://www.instagram.com/reel/C5vqFDOOTRA/?utm_source=ig_embed&amp;utm_campaign=loading" styles=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;" target="_blank" rel="noreferrer">
                        ...
                        <div styles="padding-top: 8px;">
                            <div styles=" color:#3897f0; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:550; line-height:18px;">View this post on Instagram</div>
                        </div>
                    ...
                    <p styles=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;"><a href="https://www.instagram.com/reel/C5vqFDOOTRA/?utm_source=ig_embed&amp;utm_campaign=loading" styles=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank" rel="noreferrer">A post shared by Janes Clair Ribeiro (@janesclair_rib)</a></p>
                </div>
            </blockquote>
